...
mobile ML,
including virtualisation-based and web-based.
For example,
TensorFlow.js is capable of running inside a browser or a webview on
mobile devices~\cite{smilkov2019tensorflow}.
TensorFlow.js is used by~\cite{sriraman2022device} and
\cite{palanisamy2021spliteasy}.
Another example is FedScale~\cite{lai2022fedscale},
which uses a UNIX console on Android devices to run TensorFlow directly.
