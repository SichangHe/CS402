...
\section{Customizations in Federated Learning Scheduling for Mobile Devices}

% TODO: redo the following two paragraphs.
...
it\footnote{https://github.com/FedML-AI/FedML/tree/master/ios}.

There are third on-device training solutions that are worth keeping an key on,
...
TensorFlow Federated~\cite{tensorflow2015-whitepaper,abadi2016tensorflow}
is oriented to
